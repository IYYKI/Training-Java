...
public class WorkerAdd extends JFrame {
    private JTextField Wno, Wname, Waddress, Wphoneno, Wdepart, Wsalary, Wtime, Woccup;
    private JLabel jno, jname, jaddress, jphoneno, jdepart, jsalary, jtime, joccup;
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    if (Wno.getText().toString().equals(""))
                        ...
                        JOptionPane.showMessageDialog(null, "地址不能为空", "添加", JOptionPane.WARNING_MESSAGE);
                    else if (Wphoneno.getText().toString().equals(""))
                        JOptionPane.showMessageDialog(null, "电话不能为空", "添加", JOptionPane.WARNING_MESSAGE);
                    else if (Wdepart.getText().toString().equals(""))
                        JOptionPane.showMessageDialog(null, "部门不能为空", "添加", JOptionPane.WARNING_MESSAGE);
                    else
                        o.tianjia(Wno.getText().toString(), Wname.getText().toString(), Waddress.getText().toString(),
