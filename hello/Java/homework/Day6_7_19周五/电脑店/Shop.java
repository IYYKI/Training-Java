package homework.Day6_7_19周五.电脑店;


public class Shop {
    private final int Number = 60;
    private homework.Day6_7_19周五.电脑店.Computer[] computers;
    public Shop(){
        //computers = new homework.Day6_7_19周五.电脑店.Computer[][][Number];
        for (int i = 0; i<computers.length;i++){
            computers [i] = new homework.Day6_7_19周五.电脑店.Computer("华硕电脑",5999,"序列号: "+"FVFXL0WRHV2F");
        }
    }
