...
function addItem() {
	...
	oCell.innerHTML = "<input type='text'  name='spbm' size='10' readonly> <span class='LL'><image src='WEB-INF/images/selectDate.gif' onClick='choiceSpxx(\"" + (oRow.rowIndex - 1) + "\")'></span>";
...
function delItem(index) {
	...
	for (i = index; i < rowNum; i++) {
		...
		detailTable.rows[i].cells[rowlength - 1].innerHTML = "<image src=\"WEB-INF/images/delete.gif\" class=\"LL\" onclick=\"delItem(" + i + ")\"/>";
	}
}
function hiddenDiv() {
